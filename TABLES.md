...
Лог таблицы - это история изменений данных в таблицы. Лог используется для синхронизации между презентациями, внешними приложениями или интегрируемыми системами и облегчает процесс интеграции. Лог эта таблица состоящая из трех полей:
